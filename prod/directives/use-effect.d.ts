...
export declare const useEffect: (callback: (target: HTMLElement) => any, observables?: State<any>[]) => import("lit-html/directive").DirectiveResult<typeof UseEffectDirective>;
